    ...
    <div class="select-worker page-wrapper">
      ...
      >
        <div class="firm-list" :class="{ selected: disableFirms }">
          <h5 class="title">{{ $t('firms_list') }}</h5>
        ...
        <div class="worker-list">
          <h5 class="title">{{ $t('workers_list') }}</h5>
          <div class="list-wrapper">
            <div
              class="list-item"
      ...
      <div class="report-list" id="print-report">
        ...
        <h5 class="total-money">
          <span class="no-print">{{ $t('total') }}: </span>{{ total | numberFormatter }}
        </h5>
        <div class="submit-btns no-print">
          ...
          <div class="button-wrapper">
            <button
              ...
              class="waves-effect waves-light btn"
            >
              <span v-if="saveHint">{{ $t('save_hint') }}</span>
